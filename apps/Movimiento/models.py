...
class Movimiento(models.Model):
    ...
    tarjetaDestino = models.ForeignKey(
        Tarjeta, on_delete=models.CASCADE, related_name='tarjetaDestino')
    tarjetaOrigen = models.ForeignKey(
        Tarjeta, on_delete=models.CASCADE, related_name='tarjetaOrigen')
